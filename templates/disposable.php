...
<div class="wrap wsc-admin" id="wp-span-checker-wrap">
	...
	wp_span_checker_admin_page_header(
		...
		__( 'Block throwaway and temporary email hosts. The plugin ships with a starter list you can extend.', 'wp-span-checker' )
	);
	?>
	...
	<div class="wsc-card wsc-card--table">
		<h2 class="wsc-card__title"><?php esc_html_e( 'Disposable list', 'wp-span-checker' ); ?></h2>
