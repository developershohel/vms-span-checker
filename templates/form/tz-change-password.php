...
/**
 * Change Password form  for our theme
 *
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-lg-12">
            <div id="tz-form-section" <?php post_class( 'tz-form-section' ); ?>>
                <div id="tz-change-password-form-section" class="align-items-center">
                    ...
                    <div id="tz-form-header" class="mb-4">
                        <h1 class="tz-form-title">Change Password</h1>
                    </div>
                    ...
                    <div id="tz-change-password-form">
                        <div id="tz-form-body">
                            <form action="<?php the_permalink() ?>" class="tz-change-password-form" method="post" nonce="tz_nonce"
                                  id="login">
                                <div id="tz-password" class="mb-4">
                                    <i class="user-icon fa fa-lock"></i>
                                    <input type="password" name="tz_password" placeholder="New Password">
                                </div>
                                <div id="tz-confirm-password" class="mb-4">
                                    <i class="user-icon fa fa-lock"></i>
                                    <input type="password" name="tz_confirm_password" placeholder="Confirm New Password">
                                </div>
                                <div id="tz-submit">
                                    <input type="submit" value="Change Password" name="tz_change_password">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div id="tz-form-footer" class="mb-3">
                        <div id="form-redirect-link" class="d-flex align-items-center justify-content-center mb-2">
                            <span>Don't have an account? <a href="<?php tz_post_redirect('signup') ?>" class="pe-2">Sing Up</a> </span>
                        </div>
                        <div id="form-footer-menu">
                            <ul class="nav navbar-expand">
                                ...
                                <li class="nav-item"><a class="nav-link" href="<?php echo get_privacy_policy_url();?>">Privacy Policy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
